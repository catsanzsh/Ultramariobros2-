...
struct Vertex {
    ...
    float r, g, b;       // Color of the vertex
};
...
// Enhanced lighting calculations for better performance and visuals
void applyEnhancedLighting(Vertex &vertex, const Light &light, const Material &material) {
    // Calculate ambient component
    float ambient[3] = {
        material.ambient[0] * light.r,
        material.ambient[1] * light.g,
